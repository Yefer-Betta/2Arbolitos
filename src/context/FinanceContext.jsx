...
export function FinanceProvider({ children }) {
    ...
    const closeDay = async (summary) => {
        const newClosure = {
            ...
            salesByMethod: summary.salesByMethod || { cash_cop: 0, cash_usd: 0, cash_bs: 0, nequi: 0, debit: 0 },
            countedCash: summary.countedCash || 0,
            countedUsd: summary.countedUsd || 0,
            countedBs: summary.countedBs || 0,
            countedNequi: summary.countedNequi || 0,
            countedDebit: summary.countedDebit || 0,
            differences: summary.differences || { cash_cop: 0, cash_usd: 0, cash_bs: 0, nequi: 0, debit: 0 },
